"""Plugin discovery and registration for ArgusCloud."""
...
class PluginRegistry:
    """Registry for managing ArgusCloud plugins.
    ...
    def discover(self) -> List[str]:
        ...
        Looks for plugins registered under 'arguscloud.plugins' entry point.
        ...
        try:
            if sys.version_info >= (3, 10):
                ...
                eps = entry_points(group="arguscloud.plugins")
            else:
                from importlib.metadata import entry_points
                all_eps = entry_points()
                eps = all_eps.get("arguscloud.plugins", [])
