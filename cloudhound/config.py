"""CloudHound centralized configuration management.
...
class Settings(BaseSettings):
    """CloudHound application settings.

    All settings can be overridden via environment variables
    prefixed with CLOUDHOUND_.

    Example:
        CLOUDHOUND_API_PORT=8080
    ...
    def get_cors_origins(self) -> List[str]:
        ...
        cors_env = os.environ.get("CLOUDHOUND_CORS_ORIGINS", "")
        if cors_env:
