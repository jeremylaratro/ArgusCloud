"""OpenAPI/Swagger schema definitions for CloudHound API.
...
API_INFO = {
    "title": "CloudHound API",
    "version": "0.2.0",
    "description": """
CloudHound is a multi-cloud security graph analytics tool that helps
