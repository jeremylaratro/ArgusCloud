"""Base plugin class for CloudHound extensions."""
...
class Plugin(ABC):
    """Base class for CloudHound plugins.

    Plugins can extend CloudHound with:
        ...
        class SchedulerPlugin(Plugin):
            ...
            def info(self) -> PluginInfo:
                return PluginInfo(
                    name="scheduler",
                    version="1.0.0",
                    description="Scheduled scan support for CloudHound",
                    author="CloudHound Team",
    ...
    def register_cli(self, subparsers: "argparse._SubParsersAction") -> None:
        ...
        Override this to add commands to the cloudhound CLI.
